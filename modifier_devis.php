...
if(!empty($_GET['update_id']) && $_GET['update_id']) {
	$invoiceValues = $invoice->getDevis($_GET['update_id']);		
	$invoiceItems = $invoice->getDevisItems($_GET['update_id']);		
}
?>
		      	...
		      	<div class="row">	
				 	    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group mt-3 mb-3">
								...
								<div class="input-group">
									...
									<input value="<?php echo $invoiceValues['totalht']; ?>" type="number" class="form-control" name="subTotal" id="subTotal" placeholder="Subtotal">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group-prepend">
									...
									<input value="<?php echo $invoiceValues['TVArate']; ?>" type="number" class="form-control" name="taxRate" id="taxRate" placeholder="Tax Rate">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input value="<?php echo $invoiceValues['TVAamount']; ?>" type="number" class="form-control" name="taxAmount" id="taxAmount" placeholder="Tax Amount">
								</div>
							</div>	
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">						
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-append currency"><span class="input-group-text">$</span></div>
									<input value="<?php echo $invoiceValues['totalttc']; ?>" type="number" class="form-control" name="totalAftertax" id="totalAftertax" placeholder="Total">
								</div>
							</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-append currency"><span class="input-group-text">$</span></div>
									<input value="<?php echo $invoiceValues['remise']; ?>" type="number" class="form-control" name="remise" id="amountPaid" placeholder="Amount Paid">
								</div>
							</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-append currency"><span class="input-group-text">$</span></div>
									<input value="<?php echo $invoiceValues['baseht']; ?>" type="number" class="form-control" name="baseht" id="amountDue" placeholder="Base HT">
								</div>
							</div>
							</div>
		     		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 center">
						...
						<div class="form-group">
							...
							<input type="hidden" value="<?php echo $invoiceValues['id_devis']; ?>" class="form-control" name="invoiceId" id="invoiceId">
