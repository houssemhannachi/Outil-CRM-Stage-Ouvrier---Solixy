				  ...
				  <div class="card-body">
				  	<form id="get_order_data" onsubmit="return false">
				  		<div class="form-group row">
				  			...
				  			<div class="col-sm-6">
				  				<input type="date" id="order_date" name="order_date" readonly class="form-control form-control-sm" >
				  			</div>
				  		</div>
				  		<div class="form-group row">
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
		                        ...
		                        <center style="padding:10px;">
		                        	<button id="add" style="width:150px; height:50px;" class="btn btn-success">Add</button>
		                        	<button id="remove" style="width:150px;height:50px;" class="btn btn-danger">Remove</button>
		                        </center>
				  			</div> <!--Crad Body Ends-->
