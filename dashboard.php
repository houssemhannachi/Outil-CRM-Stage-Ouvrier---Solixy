...
<div class="sidebar">
  ...
  <ul class="nav-links">
    ...
    <li class="<?php if ($pageName == 'Clients') {
                  echo 'act';
                } ?>">
      <a href="clients.php">
    ...
    <li class="<?php if ($pageName == 'Prospects') {
                  echo 'act';
                } ?>">
    ...
    <li class="<?php if ($pageName == 'Factures') {
                  echo 'act';
                } ?>">
      <a href="facture.php">
    ...
    <li class="<?php if ($pageName == 'Devis') {
                  echo 'act';
                } ?>">
      <a href="devis.php">
    ...
    <li class="<?php if ($pageName == 'Paiements') {
                  echo 'act';
                } ?>">
      <a href="paiments.php">
