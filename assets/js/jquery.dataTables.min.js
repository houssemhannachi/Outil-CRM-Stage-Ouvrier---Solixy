...
(function(k) {
    ...
    function kb(a, b, c) {
        ...
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f &&
            (d = 0)) : "first" == b ? d = 0 : "Précedent" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : aa(a, 0, "Unknown paging action: " + b, 5);
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(filtrés depuis un total de _MAX_ éléments)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    k.extend(ec, {
        ...
        simple_numbers: function(a, b) {
            return ["Précedent", Ba(a, b), "next"]
        },
        full_numbers: function(a, b) {
            return ["first", "Précedent", Ba(a, b), "next", "last"]
        },
